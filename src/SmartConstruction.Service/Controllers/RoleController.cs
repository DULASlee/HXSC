...
public class RoleController : BaseApiController
{
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "获取角色失败"); return Error("获取失败"); }
    }
    ...
    public async Task<IActionResult> GetById(Guid id)
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "获取角色失败: Id={Id}", id); return Error("获取失败"); }
    }
    ...
    public async Task<IActionResult> Create([FromBody] CreateRoleRequest request)
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "创建角色失败"); return Error("创建失败"); }
    }
    ...
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateRoleRequest request)
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "更新角色失败: Id={Id}", id); return Error("更新失败"); }
    }
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "删除角色失败: Id={Id}", id); return Error("删除失败"); }
    }
} 