...
public class UserRoleController : BaseApiController
{
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "获取用户角色失败"); return Error("获取失败"); }
    }
    ...
    public async Task<IActionResult> GetById(Guid id)
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "获取用户角色失败: Id={Id}", id); return Error("获取失败"); }
    }
    ...
    public async Task<IActionResult> Create([FromBody] CreateUserRoleRequest request)
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "创建用户角色失败"); return Error("创建失败"); }
    }

    [HttpPut("{id}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateUserRoleRequest request)
    {
        try { var result = await _service.UpdateAsync(id, request); return Success(result, "更新成功"); }
        catch (Exception ex) { _logger.LogError(ex, "更新用户角色失败: Id={Id}", id); return Error("更新失败"); }
    }
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        catch (Exception ex) { _logger.LogError(ex, "删除用户角色失败: Id={Id}", id); return Error("删除失败"); }
    }
} 